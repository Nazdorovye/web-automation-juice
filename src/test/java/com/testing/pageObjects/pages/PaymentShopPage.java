...
public class PaymentShopPage extends DeliveryMethodPage{
  ...
  public static By CARD_NAME_FIELD = css("div[class*=mat-expansion-panel-body]>div>mat-form-field:nth-of-type(1)>div>div:nth-of-type(1)>div[class*=mat-form-field-infix]>input"); // not interactable, must be traversed from higher level of hierarchy
  public static By CARD_NUMBER_FIELD = css("input[type=number]"); // interactable here? wtf?
  public static By EXPIRY_MONTH_FIELD = css("div[class*=mat-expansion-panel-body]>div>mat-form-field:nth-of-type(3)>div>div:nth-of-type(1)>div[class*=mat-form-field-infix]>select"); // again, traversed from higher level of hierarchy
  public static By EXPIRY_YEAR_FIELD = css("select[id^=mat-input]:not([aria-describedby^=mat-error])"); // ok here???
  // Public methods
  // -------------------------------------------------------------------------------------------------------------------
